...
#define SAR_RECOVERY_MAX_BYTES    (64ull * 1024ull * 1024ull)
...
#define SAR_SAMPLER_CAPACITY       256u
#define SAR_SAMPLER_WAIT_100NS     (-1250000LL)
#define SAR_SAMPLER_REVISIT_100NS  2500000LL
